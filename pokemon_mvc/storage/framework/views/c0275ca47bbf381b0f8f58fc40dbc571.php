                        ...
                        <?php if(Route::has('login')): ?>
                            <div class="d-grid gap-3">
                                <?php if(auth()->guard()->check()): ?>
                                    <a href="<?php echo e(url('/dashboard')); ?>" class="btn btn-pokemon">
                                        <i class="fas fa-tachometer-alt me-2"></i> Dashboard
                                    </a>
                                <?php else: ?>
                                    <a href="<?php echo e(route('login')); ?>" class="btn btn-pokemon">
                                        <i class="fas fa-sign-in-alt me-2"></i> Log in
                                    </a>

                                    <?php if(Route::has('register')): ?>
                                        <a href="<?php echo e(route('register')); ?>" class="btn btn-pokemon">
...
</html><?php /**PATH C:\Users\gubez\OneDrive\Área de Trabalho\SPOPWEB_Pokemon_form_Lavaravel\pokemon_mvc\resources\views/welcome.blade.php ENDPATH**/ ?>